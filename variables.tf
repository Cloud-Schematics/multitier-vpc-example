...
##############################################################################
# Tier 2 Subnet Variables
##############################################################################

variable tier_2_cidr_blocks {
  description = "A list of tier 2 subnet IPs"
  type        = list(string)
  default     = [
    "172.16.40.0/25", 
    "172.16.20.0/25", 
...
variable tier_2_acl_rules {
  description = "Access control list rule set for tier 2 subnets"
  default = [
    {
      name        = "allow-all-inbound"
      action      = "allow"
...
##############################################################################
# Tier 3 Subnet Variables
##############################################################################

variable tier_3_cidr_blocks {
  description = "A list of tier 3 subnet IPs"
  type        = list(string)
  default     = [
    "172.16.10.0/26", 
    "172.16.30.0/26", 
...
variable tier_3_acl_rules {
  description = "Access control list rule set for tier 3 subnets"
  default = [
    {
      name        = "allow-all-inbound"
      action      = "allow"
